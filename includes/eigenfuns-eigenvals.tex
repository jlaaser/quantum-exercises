...
\section*{Eigenfunctions and Eigenvalues\sectionmark{Exercise: Eigenfunctions and Eigenvalues}}
	...
	\begin{questions}
		\question Assume $\ket{f}$ is an eigenket of $\hat\Omega$ with eigenvalue $\omega$, i.e.
			...
			\begin{parts}
				...
				\part What is $\braket{f|\hat\Omega|f}$?  You may assume $\ket{f}$ is normalized.
					\begin{solution}[1in]
					\end{solution}
